...
class MemberModel(db.Model, BaseModel, metaclass=MetaBaseModel):
    ...
    employment_status = db.Column(db.String(), nullable=True)
    ...
    membership_status = db.Column(db.String(), nullable=False, default="inactive")  # noqa
    ...
    loan_payments = db.relationship(
        'LoanPaymentModel', backref='members', lazy=True)
    events = db.relationship(
        'EventModel', backref='members', lazy=True)
