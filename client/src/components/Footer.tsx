...
const Footer = () => {
    return (
        <>
            <footer className="bg-neutral-950 lg:grid lg:grid-cols-5 dark:bg-gray-900">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                ...
                                <a
                                    href="#"
                                    className="block text-2xl font-medium text-gray-400 hover:opacity-75 sm:text-3xl "
                                >
                                    0123456789
                                </a>
                            </p>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <p className="font-medium text-gray-700 dark:text-white">Helpful Link</p>
                            ...
                            <div>
                                <p className="font-medium text-gray-700 dark:text-white">Company</p>
                    ...
                    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
                        <div className="sm:flex sm:items-center sm:justify-between">
                            ...
                            <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
                                &copy; {new Date().getFullYear()}. Cobex. All rights reserved.
                            </p>
                        </div>
                    </div>
                </div>
