    ...
    return (
        <>
            ...
            <div className="bg-stone-950 min-h-screen py-20 flex justify-center items-center">
                <div className="border border-gray-200 rounded-xl shadow-sm w-2/6">
                        ...
                        <div className="mt-5">
                            ...
                            <form>
                                <div className="grid gap-y-4">
                                    ...
                                    <div>
                                        <label htmlFor="confirm-password" className="block text-sm mb-2 text-gray-100">Confirm Password</label>
                                        <div className="relative">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ms-3">
                                            <label htmlFor="remember-me" className="text-sm text-gray-100">I accept the <a className="text-gray-100 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">Terms and Conditions</a></label>
                                        </div>
                                    </div>

                                    <button type="submit" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-themeThree text-white hover:bg-themeTwo focus:outline-none focus:bg-themeTwo disabled:opacity-50 disabled:pointer-events-none">Sign up</button>
                                </div>
                            </form>
                        </div>
                    </div>
