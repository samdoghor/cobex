                        ...
                        <div className="mt-5">
                            ...
                            <form onSubmit={formik.handleSubmit}>
                                <div className="grid gap-y-4 pb-4">
                                    ...
                                    <div>
                                        <label htmlFor="short_name" className="block text-sm mb-2 text-gray-100">Organisation Short Name</label>
                                        <div className="relative">
                                            <input type="text" id="short_name" name="short_name" className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="short_name-error" placeholder="Organisation's Short Name" onChange={formik.handleChange} value={formik.values.short_name} />
                                            <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                                                <svg className="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                                </svg>
                                        ...
                                        <p className="hidden text-xs text-red-600 mt-2" id="short_name-error">Please include a valid short name so we can get back to you</p>
                                    </div>
